...
export default function AddTransaction() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      setDriver({ name: "", phone: "", plate: "", destination: "" });
      setFiles([]);
    } catch (e) {
...
const styles = StyleSheet.create({
  ...
  filePreview: { backgroundColor: "#f3f4f6", padding: 10, borderRadius: 8, marginTop: 6, flexDirection: "row", justifyContent: "space-between", alignItems: "center" },
